...
# - First-run configuration via pydhcp.env (auto-generated)
...
# - On first run, pydhcp.env is created with network/path configuration
# - Delete pydhcp.env to re-run setup
#
...
')
    ...
    cat > "$env_file" <<EOF
# pydhcp environment configuration
